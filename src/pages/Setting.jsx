...
const Setting = () => {
  ...
  const {
    ...
    isSave: stockIsSave,
    isSubmitting: stockIsSubmitting,
    onSubmit: stockOnSubmit,
    handleSubmit: stockHandleSubmit
  ...
  return (
    <>
      ...
      {/* Stock Management Settings Section */}
      <AnimatedContent>
        <div className="sm:container md:p-6 p-4 w-full mx-auto bg-white dark:bg-gray-800 dark:text-gray-200 rounded-lg mt-6">
          <form onSubmit={stockHandleSubmit(stockOnSubmit)}>
            <div className="grid grid-cols-12 font-sans">
              <div className="col-span-12 md:col-span-12 lg:col-span-12 mr-3">
                <div className="lg:px-6 pt-4 lg:pl-40 lg:pr-40 md:pl-5 md:pr-5 flex-grow scrollbar-hide w-full max-h-full pb-0">
                  ...
                  <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                    ...
                    <div className="sm:col-span-3">
                      <InputAreaTwo
                        ...
                        minValue={0}
                      />
                      <Error errorName={stockErrors.low_stock_threshold} />
                  ...
                  <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                    ...
                    <div className="sm:col-span-3">
                      <InputAreaTwo
                        ...
                        minValue={0}
                      />
                      <Error errorName={stockErrors.high_stock_threshold} />
                      <p className="text-xs text-gray-500 mt-1">
                  ...
                  <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                    ...
                    <div className="sm:col-span-3">
                      <Select
                        {...stockRegister("enable_backorder", {
                      ...
                      <Error errorName={stockErrors.enable_backorder} />
                      <p className="text-xs text-gray-500 mt-1">
                  ...
                  <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                    ...
                    <div className="sm:col-span-3">
                      <Select
                        {...stockRegister("show_stock_warnings_checkout", {
                      ...
                      <Error errorName={stockErrors.show_stock_warnings_checkout} />
                      <p className="text-xs text-gray-500 mt-1">
                  ...
                  <div className="grid md:grid-cols-5 items-start sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                    ...
                    <div className="sm:col-span-3">
                      <TextArea
                        ...
                        rows={4}
                      />
                      <Error errorName={stockErrors.custom_warning_message} />
                      <p className="text-xs text-gray-500 mt-1">
